    ...
    <div id="page-content-wrapper">
        ...
        <div class="container">
            ...
            <footer class="">
                ...
                <strong>Copyright ©  2020 <a href="https://smartersvision.com">{{setting('app_name')}}</a>.</strong> All rights reserved.
...
@stack('scripts')
<script>
    var footer_text = "Copyright © 2020"; 
    $("footer strong").text(footer_text).append('<a href="https://smartersvision.com"> {{setting("app_name")}}</a>');
    $("footer .float-right").text(" ");
</script>
